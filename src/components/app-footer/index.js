...
export default memo(function CoAppFooter() {
  return (
    <FooterWrapper className="flex items-center">
    <div className="flex justify-between items-center wrap-v2 content">
      <FooterLeft className="left flex-column">
        <div className="link">
          {
      ...
      <FooterRight className="right flex">
        {
          footerImages.map((item, index) => {
            return (
              <li className="item flex flex-column items-center" key={item.link}>
